    ...
    <div className="min-h-screen bg-[#091b33] text-white flex flex-col px-4 md:px-0 py-8 pb-16">
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-8">
        ...
        <div className="flex items-center gap-2 text-base text-white mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mb-4 leading-tight uppercase">ELEVATE YOUR RIDE: A GUIDE TO ONLINE AUTO PARTS SHOPPING</h1>
          ...
          <h2 className="text-lg md:text-xl font-bold mb-2 mt-6 uppercase">1. THE CONVENIENCE OF ONLINE AUTO PARTS SHOPPING</h2>
          ...
          <h2 className="text-lg md:text-xl font-bold mb-2 mt-6 uppercase">2. EXTENSIVE RANGE OF PREMIUM AUTO PARTS</h2>
        ...
        <h3 className="mt-12 text-xl font-semibold mb-2 uppercase tracking-wide">Featured Blogs</h3>
