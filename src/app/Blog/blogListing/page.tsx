...
const blogs = [
  {
    ...
    excerpt: "Choosing the right engine oil is crucial for your car's performance and longevity. Here's what you need to know...",
    link: "#",
  },
  {
    img: "/Blog/img-2.png",
    title: "5 Signs Your Brakes Need Attention",
    excerpt: "Brakes are a critical safety component. Learn the top signs that indicate it's time for a checkup...",
    link: "#",
  },
  {
    img: "/Blog/img-3.png",
    title: "Winter Car Care Tips",
    excerpt: "Winter can be tough on vehicles. Follow these tips to keep your car running smoothly all season...",
    link: "#",
  },
];
...
export default function BlogListingPage() {
  return (
    <div className="min-h-screen bg-[#091b33] text-white flex flex-col">
      {/* Banner */}
      <div className="relative w-full h-[320px] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url(/Blog/banner.png)' }}>
      ...
      <div className="flex flex-1 w-full max-w-7xl mx-auto gap-4 md:gap-6 lg:gap-8 p-4 md:p-6 lg:p-8">
        ...
        <main className="flex-1 flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            {blogs.map((blog, i) => (
              <div key={i} className="bg-[#091627] rounded-2xl shadow-sm p-4 flex flex-col">
