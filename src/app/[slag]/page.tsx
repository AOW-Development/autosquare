                ...
                */}
                  ...
                  <section className=" mt-10">
                    ...
                    <p className="text-base text-gray-200 leading-relaxed mb-6 text-[16px]">
                      ...
                      possible for our customers and to provide after-sales
                      service in a professional manner. We want to treat you
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 mb-10">
                      <div className="bg-[#091627] rounded-l shadow-sm p-6 mb-4">
                        ...
                        <p className="text-gray-200">
                          Get your ordered parts delivered expeditiously.
                          Initial shipping on ALL Orders is FREE! (*T&C Apply*)
                        </p>
                      </div>
                      <div className="relative bg-[#091627] rounded-r shadow-sm p-4 mb-4 overflow-hidden">
                        ...
                        <div className="relative z-10">
                          ...
                          <p className="text-gray-200">
                            Enjoy peace of mind with easy returns and
                            replacements.
                          </p>
                        </div>
                      </div>
                      <div className="bg-[#091627] rounded-l shadow-sm p-8 mb-4">
                        ...
                        <p className="text-gray-200">
                          We strive and fulfill all our customer orders in a
                          timely manner.
                        </p>
                      </div>
                      <div className="relative bg-[#091627] rounded-r shadow-sm p-4 mb-4 overflow-hidden">
                      ...
                      <div className="relative bg-[#091627] rounded-r shadow-sm p-4 mb-4 overflow-hidden">
                        ...
                        <div className="relative z-10">
                          ...
                          <p className="text-gray-200">
                            We provide competitive pricing on all our products
                            with multiple options to meet your budget.
                          </p>
                        </div>
                      </div>
                    </div>
