...
export default function Checkout() {
  ...
  const isFormValid = () => {
    return formData.firstName && formData.lastName && formData.email && 
           ...
           formData.city && formData.state && formData.zipCode && termsAccepted;
  };
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-right mt-2">
              <Link href="/login" className="text-sm text-[#FFFFFF] hover:underline font-exo2">
                Have an account? Log in
              </Link>
            </div>

            {/* Form Header */}
            <h2 className="text-base font-semibold mb-6 font-exo2">RECIPIENT DETAILS</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#091627] rounded-lg p-4 space-y-6">
              ...
              <div className="border-b border-white pb-4">
                <label className="block font-exo2 mb-2">Have a coupon code?</label>
              ...
              <label className="flex items-start space-x-2">
                ...
                <span className="text-sm font-exo2">
                  ...
                  <Link href="/account/t&c" className="text-blue-400 hover:underline"> terms and conditions</Link>, 
                  <Link href="/account/warrantyAndReturn" className="text-blue-400 hover:underline"> return policy</Link> 
                  and the <Link href="/account/privacyPolicy" className="text-blue-400 hover:underline">Privacy Policy</Link> of autosquare.us *
                </span>
              </label>
