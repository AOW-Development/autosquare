...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-[#091B33] text-[#ffffff] pt-8 md:pt-14 pb-16 md:pb-22">
      <div className="mx-auto px-3 md:px-4 lg:px-8">
        {/* Breadcrumb */}
        <div className="flex items-center space-x-2 text-xs md:text-sm text-[#ffffff] mb-3 md:mb-4">
          <Link
            href="/"
        ...
        <div className="space-y-5 md:space-y-8">
          <p className="font-exo2 text-sm md:text-base lg:text-lg leading-relaxed">
            ...
            before using the autosquare.us website (the "Service") operated by
            AutoSquareCo INC ("us", "we", or "our"). Your access to and use of
          ...
          <div>
            ...
            <p className="font-exo2 text-sm md:text-base lg:text-lg leading-relaxed">
              ...
              are and will remain the exclusive property of autosquare.us and
              its licensors.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="font-exo2 text-sm md:text-base lg:text-lg leading-relaxed">
              ...
              that are not owned or controlled by autosquare.us. autosquare.us
              ...
              autosquare.us shall not be responsible or liable, directly or
