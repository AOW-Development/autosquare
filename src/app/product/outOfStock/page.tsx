      ...
      <div className="px-6 md:pl-40 md:mx-auto w-full bg-[#091b33] flex flex-col md:flex-row gap-10 min-h-screen text-white py-10">
        ...
        <div className="flex-1 flex flex-col gap-1 max-w-xl">
          ...
          <div className="text-sm text-white mb-2">
            <h2 className="text-lg font-semibold">CHECK AVAILABILITY NOW</h2>
          </div>
          ...
          <div className="flex gap-4 mb-4">
            <button
              className="flex-1 py-2 rounded transition bg-[#00a3ff] text-white hover:bg-[#1558b0] cursor-pointer"
              // disabled={inCart}
              onClick={() => {
                setDialog(true);
              }}
