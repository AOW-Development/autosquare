...
const navLinks = [
  ...
  { label: "Contact Us", type: "link", href: "/contact-us" },
  {
    ...
    sub: [
      ...
      { label: "Warranty and Return", href: "/account/warranty-and-return" },
      { label: "Shipping and Payment", href: "/account/shipping-payment-policy" },
      { label: "Privacy Policy", href: "/account/privacy-policy" },
      { label: "Terms & Conditions", href: "/account/terms-and-condition" },
      { label: "Blogs", href: "/blog/blog-listing" },
