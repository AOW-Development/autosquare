    ...
    <body style="margin:0; padding:0; font-family: Arial, sans-serif; background-color: #f9fafb;">
      <div style="max-width: 600px; margin: 0 auto; background: #fff; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
        <div style="background: #091B33; color: #fff; padding: 24px 0; text-align: center;">
          ...
          <p style="margin: 8px 0 0 0; font-size: 16px;">Support Ticket Submitted</p>
        </div>
        <div style="padding: 24px;">
          <h2 style="color: #091B33; margin: 0 0 16px 0;">New Support Ticket</h2>
          
          <div style="margin: 24px 0; padding: 16px; background: #f3f4f6; border-radius: 4px;">
            <p style="margin: 0 0 12px 0; color: #6b7280;"><strong>Full Name:</strong></p>
            <p style="margin: 0 0 16px 0; color: #1f2937;">${escapeHtml(fullName)}</p>
            
            <p style="margin: 0 0 12px 0; color: #6b7280;"><strong>Order ID:</strong></p>
            <p style="margin: 0 0 16px 0; color: #1f2937;">${escapeHtml(orderId)}</p>
            
            <p style="margin: 0 0 12px 0; color: #6b7280;"><strong>Email:</strong></p>
            <p style="margin: 0 0 16px 0; color: #1f2937;"><a href="mailto:${escapeHtml(email)}" style="color: #091B33;">${escapeHtml(email)}</a></p>
            
            <p style="margin: 0 0 12px 0; color: #6b7280;"><strong>Phone:</strong></p>
            <p style="margin: 0 0 16px 0; color: #1f2937;">${escapeHtml(phone)}</p>
